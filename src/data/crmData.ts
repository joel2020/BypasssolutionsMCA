...
export type PipelineStage = 'New' | 'Submitted' | 'In Review' | 'Underwriting' | 'Approved' | 'Offer Sent' | 'Funded' | 'Declined' | 'Withdrawn';
...
export const kpis = [
  ...
  { label: 'New Applications', value: '256', trend: '8.1%', icon: CircleDollarSign },
...
export const activities = [
  ...
  { icon: ArrowRight, description: 'Application moved to In Review', business: 'Urban Road Logistics', user: 'System', timestamp: '1d ago' },
