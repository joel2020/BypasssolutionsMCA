...
const faqs = [
  ...
  ['What funding amounts are available?', 'Available working capital depends on revenue, deposits, business history, industry, current advances, and underwriting. Elite Funding Solutions does not guarantee approval or a specific amount.'],
...
export default function FAQ() {
  return (
    <main className="pt-16 lg:pt-[72px]">
      ...
      <section className="pb-20"><div className="page-container max-w-3xl rounded-3xl bg-[#07152B] text-white p-8 lg:p-10 text-center"><h2 className="text-[30px] font-bold tracking-[-0.03em] mb-3">Still have questions?</h2><p className="text-slate-300 mb-6">Talk with a Elite Funding Solutions funding specialist before submitting your application.</p><div className="flex flex-col sm:flex-row justify-center gap-3"><Link to="/contact" className="btn-secondary bg-white text-navy-900">Contact Us</Link><Link to="/funding-fit-check" className="btn-primary">Check Funding Fit</Link></div></div></section>
    </main>
  );
}
