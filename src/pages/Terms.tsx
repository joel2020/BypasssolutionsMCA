export default function Terms() {
  const sections = [
    ...
    },
    {
      ...
      content: 'Submitting an application through Bypass Solution does not guarantee that you will receive funding. All funding is subject to review and approval by individual funding partners. Not all applicants will qualify. Funding amounts, terms, and rates may vary based on business performance, creditworthiness, time in business, and other factors determined by funding partners.',
    },
    {
    ...
    },
    {
      ...
      content: 'By submitting an application or contact form, you authorize Bypass Solution and its funding partners to contact you via phone, email, or text message regarding your application and available funding options. Standard messaging and data rates may apply. You may opt out of communications at any time.',
    },
    {
      title: '6. Credit Authorization',
      content: 'By submitting an application, you authorize Bypass Solution and its funding partners to perform credit inquiries as necessary to review your application. Our initial review may involve a soft inquiry. Funding partners may perform hard credit inquiries during their underwriting process, which may affect your credit score.',
    },
    {
    ...
    },
    {
      ...
      content: 'Bypass Solution works with third-party funding partners. We are not responsible for the actions, terms, practices, or conduct of funding partners. Each funding relationship is governed by the agreement between you and the individual funding partner. Review all agreements thoroughly before signing.',
    },
    {
      title: '9. Intellectual Property',
      content: 'All content on this website, including text, graphics, logos, and software, is the property of Bypass Solution or its content suppliers and is protected by applicable intellectual property laws. You may not reproduce, distribute, or create derivative works without express written permission.',
    },
    {
      title: '10. Limitation of Liability',
      content: 'To the maximum extent permitted by law, Bypass Solution shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of our services or inability to obtain funding. Our total liability shall not exceed the amount paid by you to Bypass Solution, if any.',
    },
    {
      title: '11. Indemnification',
      content: 'You agree to indemnify and hold harmless Bypass Solution, its officers, directors, employees, and agents from any claims, damages, losses, or expenses arising from your use of our services, violation of these terms, or infringement of any third-party rights.',
    },
    {
      title: '12. Privacy',
        ...
        <div className="max-w-[860px] mx-auto px-6 lg:px-8">
          <div className="bg-amber-50 border border-amber-200 rounded-md px-5 py-4 mb-10">
            <p className="text-[14px] text-amber-700">
              Please read these Terms of Use carefully before using Bypass Solution's services. These terms govern your use of our website and platform.
            </p>
          </div>
